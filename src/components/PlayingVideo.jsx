...
function PlayingVideo() {
    ...
    return (
        <div className="flex justify-center flex-row h-[calc(100%-56px)] z-100 mt-16">
            <div className="w-full max-w-[1580px] flex flex-col lg:flex-row">
                <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[100%-400px] px-4 py-3 lg:py-6">
                    ...
                    <div className="text-sm font-bold md:text-xl mt-4 line-clamp-2">
                        {video?.title}
                    </div>
                    <div className="flex justify-between flex-col md:flex-row mt-4 ">
                        <div className="flex">
                            ...
                            <div className="flex space-x-5">
                                ...
                                <span className="mt-1 text-center bg-red-500 px-3 pt-2 rounded-full text-white cursor-pointer hover:bg-red-700">Subscribe</span>
                    ...
                    <div className="font-semibold flex gap-x-6  rounded-xl mt-4 text-xl">
